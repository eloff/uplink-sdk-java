...
public class Tests {
  ...
  @Test
  public void TestGetMemPoolsSizes() {
    Response pools = uplink.getMemPoolsSizes();
    assertEquals(MemPoolsSizes.class, pools.getClass());
    assertEquals(((MemPoolsSizes)pools).contents.size(), 1);
  }
